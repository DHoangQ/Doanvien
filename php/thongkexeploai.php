...
$sql = "SELECT dgtheonam.id, dgtheonam.iddv, dgtheonam.tendoanvien, dgtheonam.idchidoan, chidoan.tenchidoan, dgtheonam.xeploai
FROM dgtheonam
INNER JOIN chidoan ON dgtheonam.idchidoan = chidoan.idchidoan";;
...
<body>
    ...
    <h2 style="margin-left:30%; margin-top:15px;">BẢNG THỐNG KÊ XẾP LOẠI CÁC ĐOÀN VIÊN</h2>
